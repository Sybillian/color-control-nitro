...
execute if score sudden_death game_data matches 0 if score game_mode game_data matches 0 as @e[type=minecraft:area_effect_cloud,tag=cube_core,scores={cube_type=2..}] at @s if blocks ~ ~1 ~ ~-1 ~1 ~-1 17 51 17 all positioned ~-2 ~1 ~-2 run scoreboard players add §c points 1
execute if score sudden_death game_data matches 0 if score game_mode game_data matches 0 as @e[type=minecraft:area_effect_cloud,tag=cube_core,scores={cube_type=2..}] at @s if blocks ~ ~1 ~ ~-1 ~1 ~-1 -19 51 -19 all positioned ~-2 ~1 ~-2 run scoreboard players add §9 points 1
